...
trial\thanks{Preprint version available:
...
\maketitle
\begin{abstract}
Resistance training (RT) volume has been theorised to increase
hypertrophy in a positive, monotonic manner with diminishing returns. In
trained individuals, however, hypertrophic adaptations are typically
small due to the linear-logarithmic pattern of RT adaptation over time,
suggesting that differences between intervention volumes may also be
small. Rather than testing for superiority, we conducted a preregistered
equivalence trial comparing low- (9 fractional sets/week) and
high-volume (36 fractional sets/week) RT in previously trained
participants. In a randomised controlled trial across 22 sites, 125
participants were recruited and randomly assigned to low- (n = 56) or
high-volume (n = 64) RT for 12 weeks. Our primary estimand of interest
was the condition × time interaction effect for analysis of pooled
standardised measures for muscle size. The smallest effect size of
interest for was set at {[}-0.1, 0.1{]}. Following randomisation, 112
participants completed baseline testing and 87 completed
post-intervention testing; all data were analysed. The condition × time
interaction was 0.023 (90\% CI: -0.044 to 0.091), with an equivalence
test of p = 0.032, supporting statistically equivalent effects between
conditions. Time effects were also small (0.087, 95\% CI: 0.047 to
0.128) and further corroborate the linear-log theory of adaptation.
\end{abstract}


\textbf{Word count: 5478}
...
Justification}\label{sample-size-estimation-and-justification}
...
\pandocbounded{\includegraphics[keepaspectratio]{submission_manuscript_files/figure-pdf/fig-hypertrophy-plot-1.pdf}}
