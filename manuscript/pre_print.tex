...
are actually very similar to those reported in prior studies (Housh et
al., 1995; DeFreitas et al., 2010; @ Heymsfield et al., 1982). Further,
in our original simulations we included the estimated variance between
...
of statistical equivalence holds (condition:time = 0.019 {[}95\%CI:
