...
statistical power (i.e., \textasciitilde80\%). Lastly, for strength
outcomes\footnote{In an earlier version of this manuscript and in the
  pre-registration updates we had noted that, whilst we originally
  planned to utilise structured client workout records using
  StrengthPortal as in our previous study (Gschneidner et al., 2025),
  prior to the study launch Discover Strength stopped using this
  software. As such, workout records were manually recorded across sites
  via googlesheet workout cards. This resulted in a large amount of
  ...
  However, due to feedback from readers/reviewers JS took the time to go
  through and manually export and prepare the data available in these
  workout cards to subsequently use for analysis of estimated 1RMs for
  strength outcomes. As such, this version of the manuscript contains
  these whereas earlier versions do not.} we deviate slightly in that,
instead of examining only leg press, chest press, and pulldown exercises
we examined all direct and indirect exercises as per the fractional set
volume approach and explore these standardised within each exercise and
pooled as detailed in the statistical analysis. Note, the methods
described here pertain to the updated pre-registered methods.
