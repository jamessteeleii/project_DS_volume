...
time and the condition:time interaction effect. The grey band on the
main effect of time plot shows the 95\% confidence interval for the
effect predicted from the linear-log meta-regression of hypertrophy
outcomes in previous studies estimated from (Steele et al., 2023).}
